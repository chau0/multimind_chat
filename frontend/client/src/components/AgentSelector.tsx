  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-sm font-medium text-gray-700">{currentAgent.displayName || currentAgent.name}</span>
            ...
            {agents.map((agent) => (
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-sm font-medium text-gray-900">{agent.displayName || agent.name}</div>
