...
This complements the SQLAlchemy database connection for operations that benefit from Supabase's features.
"""
...
async def test_supabase_connection() -> bool:
    ...
    try:
        ...
        # Simple test query
        response = client.table('agents').select('count').execute()
